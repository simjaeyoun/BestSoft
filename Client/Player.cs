...
namespace 로그인화면
{
    public class Player
    {
        ...
        public Player(Ch_Color clr, string add)
        {
            ...
            if (clr == Ch_Color.Black) { location.X = 392; location.Y = 244 - 60; }

            else if (clr == Ch_Color.Orange) { location.X = 392; location.Y = 244 + 60; }

            else if (clr == Ch_Color.Green) { location.X = 392 - 60; location.Y = 244; }

            else if (clr == Ch_Color.Blue) { location.X = 392 + 60; location.Y = 244; }
