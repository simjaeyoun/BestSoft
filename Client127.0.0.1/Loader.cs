...
namespace 로그인화면
{
    ...
    internal class Loader
    {
        ...
        public static void Check_Character(StudentData studentData)
        {
            ...
            else if (studentData.clr == Ch_Color.Orange) { Selected_Character[(int)Ch_Color.Orange] = false; }
            else if (studentData.clr == Ch_Color.Green) { Selected_Character[(int)Ch_Color.Green] = false; }
            else if (studentData.clr == Ch_Color.Blue) { Selected_Character[(int)Ch_Color.Blue] = false; }
        }
